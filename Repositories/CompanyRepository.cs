    ...
    public static class CompanyRepository {
        ...
        public static async Task CreateIfNotExistsAsync() {
            ...
            (
                ...
                await createTableCommand.ExecuteNonQueryAsync().WaitAsync(TimeSpan.FromMilliseconds(1000));
                await SeedAsync();
            }
        ...
        SELECT SCOPE_IDENTITY();";
            ...
            command.Parameters.AddWithValue("@ImageLink", company.ImageLink);  // Dodaj to
